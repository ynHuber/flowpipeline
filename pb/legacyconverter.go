...
func (legacy *LegacyEnrichedFlow) ConvertToEnrichedFlow() *EnrichedFlow {
	enrichedFlow := EnrichedFlow{
		...
		NetId:                         legacy.NetId,
		NetIdString:                   legacy.NetIdString,
		SrcId:                         legacy.SrcId,
		SrcIdString:                   legacy.SrcIdString,
		DstId:                         legacy.DstId,
		DstIdString:                   legacy.DstIdString,
...
func (flow *EnrichedFlow) ConvertToLegacyEnrichedFlow() *LegacyEnrichedFlow {
	...
	legacyFlow := LegacyEnrichedFlow{
		...
		DstCid:                        flow.DstCid,
		NetId:                         flow.NetId,
		NetIdString:                   flow.NetIdString,
		SrcId:                         flow.SrcId,
		SrcIdString:                   flow.SrcIdString,
		DstId:                         flow.DstId,
		DstIdString:                   flow.DstIdString,
