...
func TestSegment_AddCid_noLocalAddrKeep(t *testing.T) {
	result := segments.TestSegment("addcid", map[string]string{"filename": "../../../examples/configurations/enricher/subnet_ids.csv"},
...
func TestSegment_AddCid_noLocalAddrDrop(t *testing.T) {
	result := segments.TestSegment("addcid", map[string]string{"filename": "../../../examples/configurations/enricher/subnet_ids.csv", "dropunmatched": "true"},
		&pb.EnrichedFlow{RemoteAddr: 0, SrcAddr: []byte{192, 168, 88, 142}})
	if result != nil {
...
func TestSegment_AddCid_bothAddrs(t *testing.T) {
	result := segments.TestSegment("addcid", map[string]string{"matchboth": "1", "filename": "../../../examples/configurations/enricher/subnet_ids.csv"},
...
func BenchmarkAddCid(b *testing.B) {
	...
	segment := AddCid{}.New(map[string]string{"filename": "../../../examples/configurations/enricher/subnet_ids.csv"})
