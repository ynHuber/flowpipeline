...
func TestSegment_GeoLocation_noRemoteAddrKeep(t *testing.T) {
	result := segments.TestSegment("geolocation", map[string]string{"filename": "../../../examples/configuration/enricher/GeoLite2-Country-Test.mmdb"},
...
func TestSegment_GeoLocation_noRemoteAddrDrop(t *testing.T) {
	result := segments.TestSegment("geolocation", map[string]string{"filename": "../../../examples/configuration/enricher/GeoLite2-Country-Test.mmdb", "dropunmatched": "1"},
		&pb.EnrichedFlow{RemoteAddr: 0, SrcAddr: []byte{2, 125, 160, 218}, DstAddr: []byte{2, 125, 160, 218}})
	if result != nil {
...
func TestSegment_GeoLocation_both(t *testing.T) {
	result := segments.TestSegment("geolocation", map[string]string{"filename": "../../../examples/configuration/enricher/GeoLite2-Country-Test.mmdb", "matchboth": "1"},
...
func BenchmarkGeoLocation(b *testing.B) {
	...
	segment := GeoLocation{}.New(map[string]string{"filename": "../../../examples/configuration/enricher/GeoLite2-Country-Test.mmdb"})
